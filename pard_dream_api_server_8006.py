...
# # --- Configuration ---
# config_path = os.environ.get("PARD_CONFIG_PATH_8006", "config.json")
...
#     with open("metrics_8006.jsonl", "a") as f:
...
def create_chat_completion(request: ChatCompletionRequest):
    ...
    # 3. Log QA to debug8006.jsonl
    qa_record = {
        "question": prompt,
        "answer": generated_text,
        "timestamp": time.time()
    }
    with open("debug8006.jsonl", "a") as f:
